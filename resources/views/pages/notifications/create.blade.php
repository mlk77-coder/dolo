...
@section('content')
    <x-common.page-breadcrumb pageTitle="Create Notification" />
    <x-common.component-card title="Create Notification">
        <form action="{{ route('notifications.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="sent_at" value="{{ old('sent_at') }}" class="w-full px-4 py-2 border rounded-lg">
            ...
            <div>
                ...
                <textarea name="message" rows="4" class="w-full px-4 py-2 border rounded-lg">{{ old('message') }}</textarea>
