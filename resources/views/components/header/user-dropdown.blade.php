...
<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11 flex-shrink-0">
            <img src="{{ Auth::user()->avatar ? Storage::url(Auth::user()->avatar) : '/images/user/owner.png' }}" alt="User" class="w-full h-full object-cover" />
        </span>
